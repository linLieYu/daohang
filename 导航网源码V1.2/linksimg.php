                      ...
                      <section class="panel">
                          ...
                          <table class="table table-striped table-advance table-hover">
                              ...
                              <tr>
                                  ...
                                  <th><i class=" icon-picture"></i> 导航图片地址</th>
                                ...
                                <?php
                                  while($array = mysqli_fetch_array($r1)){
                                    echo "<tr x-id=".$array['0'].">
                                          ...
                                          <td><a href=".$array['3']." target=\"_blank\">".$array['1']."</a></td>
    ...
    <script type="text/javascript">
			$(document).ready(function() {
				...
				$("button.x-edit").bind("click", function() {
					...
					//取值&賦值
					//1
					var atext = nodes[0].children[0].innerText;
					nodes[0].innerHTML = '<input type="text" value="' + atext + '"></input>';
					//2
					var ltext = nodes[1].innerText;
					nodes[1].innerHTML = '<input type="text" value="' + ltext + '"></input>';
					//3
					var ptext = nodes[2].innerText;
					nodes[2].innerHTML = '<input type="text" value="' + ptext + '"></input>';
				});
				//submit
				$("button.x-submit").bind("click", function() {
					...
					if(nodes[1].children[0] != undefined) {
						//取值
						//1
						var atext = nodes[0].children[0].value;
						//2
						var ltext = nodes[1].children[0].value;
						//3
						var ptext = nodes[2].children[0].value;
						...
						isEdit = $.ajax({data: {id: this.parentNode.parentNode.getAttribute('x-id'),atext: atext, ltext: ltext ,ptext: ptext},type:'POST',url:"ajax.php",async:false});
						...
						//賦值
						//1
						nodes[0].innerHTML = '<a href="' + ltext + '">' + atext + '</a>';
						//2
						nodes[1].innerHTML = ltext;
						//3
						nodes[2].innerHTML = ptext;
					}
				});
			});
		</script>
